<template>
  <div id="gist108293953" class="gist">
    <div class="gist-file" translate="no">
      <div class="gist-data">
        <div class="js-gist-file-update-container js-task-list-container file-box">
          <div id="file-hive-basic-sql" class="file my-2">
    ...
    <path
      d="M6.457 1.047c.659-1.234 2.427-1.234 3.086 0l6.082 11.378A1.75 1.75 0 0 1 14.082 15H1.918a1.75 1.75 0 0 1-1.543-2.575Zm1.763.707a.25.25 0 0 0-.44 0L1.698 13.132a.25.25 0 0 0 .22.368h12.164a.25.25 0 0 0 .22-.368Zm.53 3.996v2.5a.75.75 0 0 1-1.5 0v-2.5a.75.75 0 0 1 1.5 0ZM9 11a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"></path>
                ...
                <table class="highlight tab-size js-file-line-container js-code-nav-container js-tagsearch-file"
                       ...
                       data-tagsearch-path="hive-basic.sql">
                  <tr>
                    <td id="file-hive-basic-sql-L1" class="blob-num js-line-number js-code-nav-line-number js-blob-rnum"
                        data-line-number="1"></td>
                    <td id="file-hive-basic-sql-LC1" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c"><span class="pl-c">/*</span> How to create a database <span
                      class="pl-c">*/</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L2" class="blob-num js-line-number js-code-nav-line-number js-blob-rnum"
                        data-line-number="2"></td>
                    <td id="file-hive-basic-sql-LC2" class="blob-code blob-code-inner js-file-line"><span class="pl-k">CREATE</span>
                      <span class="pl-k">DATABASE</span> <span class="pl-en">test_db</span>;
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L3" class="blob-num js-line-number js-code-nav-line-number js-blob-rnum"
                        data-line-number="3"></td>
                    <td id="file-hive-basic-sql-LC3" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c"><span class="pl-c">--</span> Show the query in the history</span></td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L4" class="blob-num js-line-number js-code-nav-line-number js-blob-rnum"
                        data-line-number="4"></td>
                    <td id="file-hive-basic-sql-LC4" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L5" class="blob-num js-line-number js-code-nav-line-number js-blob-rnum"
                        data-line-number="5"></td>
                    <td id="file-hive-basic-sql-LC5" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c"><span class="pl-c">/*</span> If try to create a database that already exists, it fails <span
                      class="pl-c">*/</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L6" class="blob-num js-line-number js-code-nav-line-number js-blob-rnum"
                        data-line-number="6"></td>
                    <td id="file-hive-basic-sql-LC6" class="blob-code blob-code-inner js-file-line"><span class="pl-k">CREATE</span>
                      <span class="pl-k">DATABASE</span> <span class="pl-en">test_db</span>;
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L7" class="blob-num js-line-number js-code-nav-line-number js-blob-rnum"
                        data-line-number="7"></td>
                    <td id="file-hive-basic-sql-LC7" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c"><span class="pl-c">--</span> Explain the query result</span></td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L8" class="blob-num js-line-number js-code-nav-line-number js-blob-rnum"
                        data-line-number="8"></td>
                    <td id="file-hive-basic-sql-LC8" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c"><span class="pl-c">--</span> Show the query in the history and that indicates the failure</span>
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L9" class="blob-num js-line-number js-code-nav-line-number js-blob-rnum"
                        data-line-number="9"></td>
                    <td id="file-hive-basic-sql-LC9" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L10"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="10"></td>
                    <td id="file-hive-basic-sql-LC10" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span
                      class="pl-c">/*</span> In order to avoid failure in scripting, we can use IF NOT EXISTS keyword <span
                      class="pl-c">*/</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L11"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="11"></td>
                    <td id="file-hive-basic-sql-LC11" class="blob-code blob-code-inner js-file-line"><span class="pl-k">CREATE</span>
                      <span class="pl-k">DATABASE</span> <span class="pl-en">IF</span> NOT EXISTS test_db;
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L12"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="12"></td>
                    <td id="file-hive-basic-sql-LC12" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L13"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="13"></td>
                    <td id="file-hive-basic-sql-LC13" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span
                      class="pl-c">/*</span> To get information on a database <span class="pl-c">*/</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L14"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="14"></td>
                    <td id="file-hive-basic-sql-LC14" class="blob-code blob-code-inner js-file-line">DESCRIBE DATABASE
                      test_db;
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L15"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="15"></td>
                    <td id="file-hive-basic-sql-LC15" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L16"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="16"></td>
                    <td id="file-hive-basic-sql-LC16" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span
                      class="pl-c">/*</span> To get a list of databses <span class="pl-c">*/</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L17"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="17"></td>
                    <td id="file-hive-basic-sql-LC17" class="blob-code blob-code-inner js-file-line">SHOW DATABASES;
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L18"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="18"></td>
                    <td id="file-hive-basic-sql-LC18" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L19"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="19"></td>
                    <td id="file-hive-basic-sql-LC19" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span
                      class="pl-c">/*</span> list databases <span class="pl-c">*/</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L20"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="20"></td>
                    <td id="file-hive-basic-sql-LC20" class="blob-code blob-code-inner js-file-line">SHOW DATABASES
                      <span class="pl-k">LIKE</span> <span class="pl-s"><span class="pl-pds">&#39;</span>bdsf2001_*<span
                        class="pl-pds">&#39;</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L21"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="21"></td>
                    <td id="file-hive-basic-sql-LC21" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L22"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="22"></td>
                    <td id="file-hive-basic-sql-LC22" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span
                      class="pl-c">/*</span> In order to drop a database <span class="pl-c">*/</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L23"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="23"></td>
                    <td id="file-hive-basic-sql-LC23" class="blob-code blob-code-inner js-file-line"><span class="pl-k">DROP</span>
                      <span class="pl-k">DATABASE</span> test_db;
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L24"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="24"></td>
                    <td id="file-hive-basic-sql-LC24" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L25"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="25"></td>
                    <td id="file-hive-basic-sql-LC25" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span
                      class="pl-c">/*</span> If try to drop a database that doesn&#39;t exist, you get an error again <span
                      class="pl-c">*/</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L26"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="26"></td>
                    <td id="file-hive-basic-sql-LC26" class="blob-code blob-code-inner js-file-line"><span class="pl-k">DROP</span>
                      <span class="pl-k">DATABASE</span> test_db;
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L27"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="27"></td>
                    <td id="file-hive-basic-sql-LC27" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L28"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="28"></td>
                    <td id="file-hive-basic-sql-LC28" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span
                      class="pl-c">/*</span> In order to avoid failure in scripting, we can use IF EXISTS keyword <span
                      class="pl-c">*/</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L29"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="29"></td>
                    <td id="file-hive-basic-sql-LC29" class="blob-code blob-code-inner js-file-line"><span class="pl-k">DROP</span>
                      <span class="pl-k">DATABASE</span> IF EXISTS test_db;
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L30"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="30"></td>
                    <td id="file-hive-basic-sql-LC30" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L31"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="31"></td>
                    <td id="file-hive-basic-sql-LC31" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span
                      class="pl-c">/*</span> A database can be created with some properties <span class="pl-c">*/</span></span>
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L32"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="32"></td>
                    <td id="file-hive-basic-sql-LC32" class="blob-code blob-code-inner js-file-line"><span class="pl-k">CREATE</span>
                      <span class="pl-k">DATABASE</span> <span class="pl-en">bdss2001_test</span></td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L33"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="33"></td>
                    <td id="file-hive-basic-sql-LC33" class="blob-code blob-code-inner js-file-line">WITH
                      DBPROPERTIES(<span class="pl-s"><span class="pl-pds">&#39;</span>creator<span
                        class="pl-pds">&#39;</span></span> <span class="pl-k">=</span> <span class="pl-s"><span
                        class="pl-pds">&#39;</span>John Doe<span class="pl-pds">&#39;</span></span>, <span class="pl-s"><span
                        class="pl-pds">&#39;</span>date<span class="pl-pds">&#39;</span></span> <span
                        class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">&#39;</span>2010-10-18<span
                        class="pl-pds">&#39;</span></span>);
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L34"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="34"></td>
                    <td id="file-hive-basic-sql-LC34" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L35"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="35"></td>
                    <td id="file-hive-basic-sql-LC35" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span
                      class="pl-c">/*</span> The properties don&#39;t show up in the normal describe and we should use extended version. <span
                      class="pl-c">*/</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L36"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="36"></td>
                    <td id="file-hive-basic-sql-LC36" class="blob-code blob-code-inner js-file-line">DESCRIBE DATABASE
                      bdss2001_test;
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L37"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="37"></td>
                    <td id="file-hive-basic-sql-LC37" class="blob-code blob-code-inner js-file-line">DESCRIBE DATABASE
                      EXTENDED bdss2001_test;
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L38"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="38"></td>
                    <td id="file-hive-basic-sql-LC38" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L39"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="39"></td>
                    <td id="file-hive-basic-sql-LC39" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span
                      class="pl-c">/*</span> Simple create table statement <span class="pl-c">*/</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L40"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="40"></td>
                    <td id="file-hive-basic-sql-LC40" class="blob-code blob-code-inner js-file-line"><span class="pl-k">CREATE</span>
                      <span class="pl-k">TABLE</span> <span class="pl-en">students</span> (
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L41"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="41"></td>
                    <td id="file-hive-basic-sql-LC41" class="blob-code blob-code-inner js-file-line"> id <span
                      class="pl-k">int</span>,
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L42"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="42"></td>
                    <td id="file-hive-basic-sql-LC42" class="blob-code blob-code-inner js-file-line"> first_name
                      string,
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L43"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="43"></td>
                    <td id="file-hive-basic-sql-LC43" class="blob-code blob-code-inner js-file-line"> last_name string
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L44"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="44"></td>
                    <td id="file-hive-basic-sql-LC44" class="blob-code blob-code-inner js-file-line">);</td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L45"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="45"></td>
                    <td id="file-hive-basic-sql-LC45" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L46"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="46"></td>
                    <td id="file-hive-basic-sql-LC46" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span
                      class="pl-c">/*</span> Get information from the table <span class="pl-c">*/</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L47"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="47"></td>
                    <td id="file-hive-basic-sql-LC47" class="blob-code blob-code-inner js-file-line">DESCRIBE
                      students;
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L48"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="48"></td>
                    <td id="file-hive-basic-sql-LC48" class="blob-code blob-code-inner js-file-line">DESCRIBE EXTENDED
                      students;
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L49"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="49"></td>
                    <td id="file-hive-basic-sql-LC49" class="blob-code blob-code-inner js-file-line">DESCRIBE FORMATTED
                      students;
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L50"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="50"></td>
                    <td id="file-hive-basic-sql-LC50" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L51"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="51"></td>
                    <td id="file-hive-basic-sql-LC51" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span
                      class="pl-c">/*</span> Simple insert statement <span class="pl-c">*/</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L52"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="52"></td>
                    <td id="file-hive-basic-sql-LC52" class="blob-code blob-code-inner js-file-line"><span class="pl-k">INSERT INTO</span>
                      students <span class="pl-k">VALUES</span> (<span class="pl-c1">1</span>, <span class="pl-s"><span
                        class="pl-pds">&#39;</span>John<span class="pl-pds">&#39;</span></span>, <span
                        class="pl-s"><span class="pl-pds">&#39;</span>Doe<span class="pl-pds">&#39;</span></span>);
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L53"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="53"></td>
                    <td id="file-hive-basic-sql-LC53" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span
                      class="pl-c">/*</span> Query records from the table <span class="pl-c">*/</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L54"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="54"></td>
                    <td id="file-hive-basic-sql-LC54" class="blob-code blob-code-inner js-file-line"><span class="pl-k">SELECT</span>
                      <span class="pl-k">*</span> <span class="pl-k">FROM</span> students
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L55"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="55"></td>
                    <td id="file-hive-basic-sql-LC55" class="blob-code blob-code-inner js-file-line"><span class="pl-k">LIMIT</span>
                      <span class="pl-c1">10</span>;
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L56"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="56"></td>
                    <td id="file-hive-basic-sql-LC56" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span
                      class="pl-c">--</span> Always use a limit to avoid accidentally getting all the data of a huge table</span>
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L57"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="57"></td>
                    <td id="file-hive-basic-sql-LC57" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L58"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="58"></td>
                    <td id="file-hive-basic-sql-LC58" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span
                      class="pl-c">/*</span> Insert a second student <span class="pl-c">*/</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L59"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="59"></td>
                    <td id="file-hive-basic-sql-LC59" class="blob-code blob-code-inner js-file-line"><span class="pl-k">INSERT INTO</span>
                      students <span class="pl-k">VALUES</span> (<span class="pl-c1">1</span>, <span class="pl-s"><span
                        class="pl-pds">&#39;</span>John<span class="pl-pds">&#39;</span></span>, <span
                        class="pl-s"><span class="pl-pds">&#39;</span>Smith<span class="pl-pds">&#39;</span></span>);
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L60"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="60"></td>
                    <td id="file-hive-basic-sql-LC60" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L61"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="61"></td>
                    <td id="file-hive-basic-sql-LC61" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span
                      class="pl-c">--</span> Check the output on HDFS /user/hive/warehouse/bdss2001_test.db/students</span>
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L62"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="62"></td>
                    <td id="file-hive-basic-sql-LC62" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span
                      class="pl-c">--</span> There is one file per insert</span></td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L63"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="63"></td>
                    <td id="file-hive-basic-sql-LC63" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span
                      class="pl-c">--</span> Check the YARN resource manager</span></td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L64"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="64"></td>
                    <td id="file-hive-basic-sql-LC64" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span
                      class="pl-c">--</span> There is one MapReduce job per SQL command</span></td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L65"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="65"></td>
                    <td id="file-hive-basic-sql-LC65" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L66"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="66"></td>
                    <td id="file-hive-basic-sql-LC66" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span
                      class="pl-c">/*</span> </span></td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L67"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="67"></td>
                    <td id="file-hive-basic-sql-LC67" class="blob-code blob-code-inner js-file-line"><span class="pl-c">In order to make Hive to avoid MapReduce, you can use </span>
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L68"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="68"></td>
                    <td id="file-hive-basic-sql-LC68" class="blob-code blob-code-inner js-file-line"><span class="pl-c">&#9;SET hive.exec.mode.local.auto=false;</span>
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L69"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="69"></td>
                    <td id="file-hive-basic-sql-LC69" class="blob-code blob-code-inner js-file-line"><span class="pl-c">It asks Hive for a configured size of data, use local processing instead of MR.</span>
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L70"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="70"></td>
                    <td id="file-hive-basic-sql-LC70" class="blob-code blob-code-inner js-file-line"><span class="pl-c">It will speed up small data queries.</span>
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L71"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="71"></td>
                    <td id="file-hive-basic-sql-LC71" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span
                      class="pl-c">*/</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L72"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="72"></td>
                    <td id="file-hive-basic-sql-LC72" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L73"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="73"></td>
                    <td id="file-hive-basic-sql-LC73" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span
                      class="pl-c">/*</span>* CLEAN UP *<span class="pl-c">*/</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-hive-basic-sql-L74"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="74"></td>
                    <td id="file-hive-basic-sql-LC74" class="blob-code blob-code-inner js-file-line"><span class="pl-k">DROP</span>
                      <span class="pl-k">DATABASE</span> bdss2001_test CASCADE;
                    </td>
                  </tr>
                </table>
              </div>
      ...
      <div class="gist-meta">
        <a
          ...
          href="https://gist.github.com/irajhedayati/e637b68f3794332a7508ac3fa56c821c/raw/4bbc30d7c5d9e3f12620b79de170eaa70ee7b91f/hive-basic.sql" style="float:right">view raw</a>
        <a class="Link--inTextBlock"
           href="https://gist.github.com/irajhedayati/e637b68f3794332a7508ac3fa56c821c#file-hive-basic-sql">
          hive-basic.sql
        </a>
...
<script>
export default { name: 'HiveSQLBasicsGist' }
</script>
<style>
.gist {
  /*!
