<template>
  <div id="gist105045101" class="gist">
    <div class="gist-file" translate="no">
      <div class="gist-data">
        <div class="js-gist-file-update-container js-task-list-container file-box">
          <div id="file-raining-csv" class="file my-2">

            <div class="Box-body p-0 blob-wrapper data type-csv  " itemprop="text">

              <div class="blob-interaction-bar">
                <svg aria-hidden="true" class="octicon octicon-search" data-view-component="true" height="16" version="1.1"
                ...
                <input aria-label="Search this file…" autocapitalize="off" class="form-control js-csv-filter-field blob-filter"
                       name="filter"
                       placeholder="Search this file…" type="text">
              </div>

              <div class="markdown-body js-check-bidi" data-hpc data-line-alert="before">
    ...
    <path
      d="M6.457 1.047c.659-1.234 2.427-1.234 3.086 0l6.082 11.378A1.75 1.75 0 0 1 14.082 15H1.918a1.75 1.75 0 0 1-1.543-2.575Zm1.763.707a.25.25 0 0 0-.44 0L1.698 13.132a.25.25 0 0 0 .22.368h12.164a.25.25 0 0 0 .22-.368Zm.53 3.996v2.5a.75.75 0 0 1-1.5 0v-2.5a.75.75 0 0 1 1.5 0ZM9 11a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"></path>
                ...
                <table class="js-csv-data csv-data js-file-line-container">
                  <thead>
                  <tr id="file-raining-csv-LC1" class="js-file-line">
                    <td id="file-raining-csv-L1" class="blob-num js-line-number" data-line-number="1"></td>
                    <th>month</th>
                    <th>rainfall</th>
                  ...
                  <tbody>
                  <tr id="file-raining-csv-LC2" class="js-file-line">
                    <td id="file-raining-csv-L2" class="blob-num js-line-number" data-line-number="2"></td>
                    <td>Jan</td>
                    <td>82</td>
                    <td>15</td>
                  </tr>
                  <tr id="file-raining-csv-LC3" class="js-file-line">
                    <td id="file-raining-csv-L3" class="blob-num js-line-number" data-line-number="3"></td>
                    <td>Feb</td>
                    <td>92.5</td>
                    <td>25</td>
                  </tr>
                  <tr id="file-raining-csv-LC4" class="js-file-line">
                    <td id="file-raining-csv-L4" class="blob-num js-line-number" data-line-number="4"></td>
                    <td>Mar</td>
                    <td>83.2</td>
                    <td>17</td>
                  </tr>
                  <tr id="file-raining-csv-LC5" class="js-file-line">
                    <td id="file-raining-csv-L5" class="blob-num js-line-number" data-line-number="5"></td>
                    <td>Apr</td>
                    <td>97.7</td>
                    <td>28</td>
                  </tr>
                  <tr id="file-raining-csv-LC6" class="js-file-line">
                    <td id="file-raining-csv-L6" class="blob-num js-line-number" data-line-number="6"></td>
                    <td>May</td>
                    <td>131.9</td>
                    <td>41</td>
                  </tr>
                  <tr id="file-raining-csv-LC7" class="js-file-line">
                    <td id="file-raining-csv-L7" class="blob-num js-line-number" data-line-number="7"></td>
                    <td>Jun</td>
                    <td>141.3</td>
                    <td>47</td>
                  </tr>
                  <tr id="file-raining-csv-LC8" class="js-file-line">
                    <td id="file-raining-csv-L8" class="blob-num js-line-number" data-line-number="8"></td>
                    <td>Jul</td>
                    <td>165.4</td>
                    <td>50</td>
                  </tr>
                  <tr id="file-raining-csv-LC9" class="js-file-line">
                    <td id="file-raining-csv-L9" class="blob-num js-line-number" data-line-number="9"></td>
                    <td>Aug</td>
                    <td>140</td>
                    <td>46</td>
                  </tr>
                  <tr id="file-raining-csv-LC10" class="js-file-line">
                    <td id="file-raining-csv-L10" class="blob-num js-line-number" data-line-number="10"></td>
                    <td>Sep</td>
                    <td>126.7</td>
                    <td>37</td>
                  </tr>
                  <tr id="file-raining-csv-LC11" class="js-file-line">
                    <td id="file-raining-csv-L11" class="blob-num js-line-number" data-line-number="11"></td>
                    <td>Oct</td>
                    <td>97.8</td>
                    <td>22</td>
                  </tr>
                  <tr id="file-raining-csv-LC12" class="js-file-line">
                    <td id="file-raining-csv-L12" class="blob-num js-line-number" data-line-number="12"></td>
                    <td>Nov</td>
                    <td>86.2</td>
                    <td>20</td>
                  </tr>
                  <tr id="file-raining-csv-LC13" class="js-file-line">
                    <td id="file-raining-csv-L13" class="blob-num js-line-number" data-line-number="13"></td>
                    <td>Dec</td>
                    <td>99.6</td>
                    <td>30</td>
                  </tr>
                  <tr id="file-raining-csv-LC14" class="js-file-line">
                    <td id="file-raining-csv-L14" class="blob-num js-line-number" data-line-number="14"></td>
                    <td>Jan</td>
                    <td>87</td>
                    <td>14</td>
                  </tr>
                  <tr id="file-raining-csv-LC15" class="js-file-line">
                    <td id="file-raining-csv-L15" class="blob-num js-line-number" data-line-number="15"></td>
                    <td>Feb</td>
                    <td>97.5</td>
                    <td>27</td>
                  </tr>
                  <tr id="file-raining-csv-LC16" class="js-file-line">
                    <td id="file-raining-csv-L16" class="blob-num js-line-number" data-line-number="16"></td>
                    <td>Mar</td>
                    <td>88.2</td>
                    <td>14</td>
                  </tr>
                  <tr id="file-raining-csv-LC17" class="js-file-line">
                    <td id="file-raining-csv-L17" class="blob-num js-line-number" data-line-number="17"></td>
                    <td>Apr</td>
                    <td>102.7</td>
                    <td>30</td>
                  </tr>
                  <tr id="file-raining-csv-LC18" class="js-file-line">
                    <td id="file-raining-csv-L18" class="blob-num js-line-number" data-line-number="18"></td>
                    <td>May</td>
                    <td>123</td>
                    <td>43</td>
                  </tr>
                  <tr id="file-raining-csv-LC19" class="js-file-line">
                    <td id="file-raining-csv-L19" class="blob-num js-line-number" data-line-number="19"></td>
                    <td>Jun</td>
                    <td>146.3</td>
                    <td>49</td>
                  </tr>
                  <tr id="file-raining-csv-LC20" class="js-file-line">
                    <td id="file-raining-csv-L20" class="blob-num js-line-number" data-line-number="20"></td>
                    <td>Jul</td>
                    <td>160</td>
                    <td>49</td>
                  </tr>
                  <tr id="file-raining-csv-LC21" class="js-file-line">
                    <td id="file-raining-csv-L21" class="blob-num js-line-number" data-line-number="21"></td>
                    <td>Aug</td>
                    <td>145</td>
                    <td>44</td>
                  </tr>
                  <tr id="file-raining-csv-LC22" class="js-file-line">
                    <td id="file-raining-csv-L22" class="blob-num js-line-number" data-line-number="22"></td>
                    <td>Sep</td>
                    <td>131.7</td>
                    <td>39</td>
                  </tr>
                  <tr id="file-raining-csv-LC23" class="js-file-line">
                    <td id="file-raining-csv-L23" class="blob-num js-line-number" data-line-number="23"></td>
                    <td>Oct</td>
                    <td>118</td>
                    <td>36</td>
                  </tr>
                  <tr id="file-raining-csv-LC24" class="js-file-line">
                    <td id="file-raining-csv-L24" class="blob-num js-line-number" data-line-number="24"></td>
                    <td>Nov</td>
                    <td>91.2</td>
                    <td>20</td>
                  </tr>
                  <tr id="file-raining-csv-LC25" class="js-file-line">
                    <td id="file-raining-csv-L25" class="blob-num js-line-number" data-line-number="25"></td>
                    <td>Dec</td>
                    <td>104.6</td>
                    <td>32</td>
                  </tr>
      ...
      <div class="gist-meta">
        <a
          ...
          href="https://gist.github.com/irajhedayati/9bcd7c4bb5280b6db18af08b7d1d789c/raw/023177d33f87bbbccac8f8b02e02cc67c4dab551/raining.csv" style="float:right">view raw</a>
        <a class="Link--inTextBlock"
           href="https://gist.github.com/irajhedayati/9bcd7c4bb5280b6db18af08b7d1d789c#file-raining-csv">
          raining.csv
        </a>
...
<script>
export default { name: 'SparkMLGist' }
</script>
<style>
.gist {
  /*!
