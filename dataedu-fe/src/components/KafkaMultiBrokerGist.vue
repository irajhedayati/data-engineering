<template>
  <div id="gist108812392" class="gist">
    <div class="gist-file" translate="no">
      <div class="gist-data">
        <div class="js-gist-file-update-container js-task-list-container file-box">
          <div id="file-docker-compose-yaml" class="file my-2">

            <div class="Box-body p-0 blob-wrapper data type-yaml  " itemprop="text">
    ...
    <path
      d="M6.457 1.047c.659-1.234 2.427-1.234 3.086 0l6.082 11.378A1.75 1.75 0 0 1 14.082 15H1.918a1.75 1.75 0 0 1-1.543-2.575Zm1.763.707a.25.25 0 0 0-.44 0L1.698 13.132a.25.25 0 0 0 .22.368h12.164a.25.25 0 0 0 .22-.368Zm.53 3.996v2.5a.75.75 0 0 1-1.5 0v-2.5a.75.75 0 0 1 1.5 0ZM9 11a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"></path>
                ...
                <table class="highlight tab-size js-file-line-container js-code-nav-container js-tagsearch-file"
                       data-hpc
                       data-paste-markdown-skip data-tab-size="8" data-tagsearch-lang="YAML"
                       data-tagsearch-path="docker-compose.yaml">
                  <tr>
                    <td id="file-docker-compose-yaml-L1"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="1"></td>
                    <td id="file-docker-compose-yaml-LC1" class="blob-code blob-code-inner js-file-line">---</td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L2"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="2"></td>
                    <td id="file-docker-compose-yaml-LC2" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">version</span>: <span class="pl-s"><span class="pl-pds">&#39;</span>2<span
                      class="pl-pds">&#39;</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L3"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="3"></td>
                    <td id="file-docker-compose-yaml-LC3" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">services</span>:
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L4"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="4"></td>
                    <td id="file-docker-compose-yaml-LC4" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">zookeeper</span>:
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L5"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="5"></td>
                    <td id="file-docker-compose-yaml-LC5" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">image</span>: <span class="pl-s">confluentinc/cp-zookeeper:5.5.1</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L6"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="6"></td>
                    <td id="file-docker-compose-yaml-LC6" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">hostname</span>: <span class="pl-s">zookeeper</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L7"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="7"></td>
                    <td id="file-docker-compose-yaml-LC7" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">container_name</span>: <span class="pl-s">zookeeper</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L8"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="8"></td>
                    <td id="file-docker-compose-yaml-LC8" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">ports</span>:
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L9"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="9"></td>
                    <td id="file-docker-compose-yaml-LC9" class="blob-code blob-code-inner js-file-line"> - <span
                      class="pl-c1">2181:2181</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L10"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="10"></td>
                    <td id="file-docker-compose-yaml-LC10" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">environment</span>:
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L11"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="11"></td>
                    <td id="file-docker-compose-yaml-LC11" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">ZOOKEEPER_CLIENT_PORT</span>: <span class="pl-c1">2181</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L12"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="12"></td>
                    <td id="file-docker-compose-yaml-LC12" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">ZOOKEEPER_TICK_TIME</span>: <span class="pl-c1">2000</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L13"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="13"></td>
                    <td id="file-docker-compose-yaml-LC13" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L14"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="14"></td>
                    <td id="file-docker-compose-yaml-LC14" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">broker1</span>:
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L15"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="15"></td>
                    <td id="file-docker-compose-yaml-LC15" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">image</span>: <span class="pl-s">confluentinc/cp-kafka:5.5.1</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L16"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="16"></td>
                    <td id="file-docker-compose-yaml-LC16" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">hostname</span>: <span class="pl-s">broker1</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L17"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="17"></td>
                    <td id="file-docker-compose-yaml-LC17" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">container_name</span>: <span class="pl-s">broker1</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L18"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="18"></td>
                    <td id="file-docker-compose-yaml-LC18" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">depends_on</span>:
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L19"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="19"></td>
                    <td id="file-docker-compose-yaml-LC19" class="blob-code blob-code-inner js-file-line"> - <span
                      class="pl-s">zookeeper</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L20"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="20"></td>
                    <td id="file-docker-compose-yaml-LC20" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">ports</span>:
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L21"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="21"></td>
                    <td id="file-docker-compose-yaml-LC21" class="blob-code blob-code-inner js-file-line"> - <span
                      class="pl-c1">29092:29092</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L22"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="22"></td>
                    <td id="file-docker-compose-yaml-LC22" class="blob-code blob-code-inner js-file-line"> - <span
                      class="pl-c1">9092:9092</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L23"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="23"></td>
                    <td id="file-docker-compose-yaml-LC23" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">environment</span>:
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L24"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="24"></td>
                    <td id="file-docker-compose-yaml-LC24" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">KAFKA_BROKER_ID</span>: <span class="pl-c1">1</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L25"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="25"></td>
                    <td id="file-docker-compose-yaml-LC25" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">KAFKA_ZOOKEEPER_CONNECT</span>: <span class="pl-s"><span
                      class="pl-pds">&#39;</span>zookeeper:2181<span class="pl-pds">&#39;</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L26"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="26"></td>
                    <td id="file-docker-compose-yaml-LC26" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">KAFKA_LISTENER_SECURITY_PROTOCOL_MAP</span>: <span class="pl-s">PLAINTEXT:PLAINTEXT,PLAINTEXT_HOST:PLAINTEXT</span>
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L27"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="27"></td>
                    <td id="file-docker-compose-yaml-LC27" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">KAFKA_ADVERTISED_LISTENERS</span>: <span class="pl-s">PLAINTEXT://broker1:29092,PLAINTEXT_HOST://localhost:9092</span>
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L28"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="28"></td>
                    <td id="file-docker-compose-yaml-LC28" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">KAFKA_OFFSETS_TOPIC_REPLICATION_FACTOR</span>: <span class="pl-c1">1</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L29"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="29"></td>
                    <td id="file-docker-compose-yaml-LC29" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">KAFKA_TRANSACTION_STATE_LOG_MIN_ISR</span>: <span class="pl-c1">1</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L30"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="30"></td>
                    <td id="file-docker-compose-yaml-LC30" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">KAFKA_TRANSACTION_STATE_LOG_REPLICATION_FACTOR</span>: <span class="pl-c1">1</span>
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L31"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="31"></td>
                    <td id="file-docker-compose-yaml-LC31" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">KAFKA_GROUP_INITIAL_REBALANCE_DELAY_MS</span>: <span class="pl-c1">0</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L32"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="32"></td>
                    <td id="file-docker-compose-yaml-LC32" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L33"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="33"></td>
                    <td id="file-docker-compose-yaml-LC33" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">broker2</span>:
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L34"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="34"></td>
                    <td id="file-docker-compose-yaml-LC34" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">image</span>: <span class="pl-s">confluentinc/cp-kafka:5.5.1</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L35"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="35"></td>
                    <td id="file-docker-compose-yaml-LC35" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">hostname</span>: <span class="pl-s">broker2</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L36"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="36"></td>
                    <td id="file-docker-compose-yaml-LC36" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">container_name</span>: <span class="pl-s">broker2</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L37"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="37"></td>
                    <td id="file-docker-compose-yaml-LC37" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">depends_on</span>:
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L38"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="38"></td>
                    <td id="file-docker-compose-yaml-LC38" class="blob-code blob-code-inner js-file-line"> - <span
                      class="pl-s">zookeeper</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L39"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="39"></td>
                    <td id="file-docker-compose-yaml-LC39" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">ports</span>:
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L40"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="40"></td>
                    <td id="file-docker-compose-yaml-LC40" class="blob-code blob-code-inner js-file-line"> - <span
                      class="pl-c1">29093:29093</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L41"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="41"></td>
                    <td id="file-docker-compose-yaml-LC41" class="blob-code blob-code-inner js-file-line"> - <span
                      class="pl-c1">9093:9093</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L42"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="42"></td>
                    <td id="file-docker-compose-yaml-LC42" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">environment</span>:
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L43"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="43"></td>
                    <td id="file-docker-compose-yaml-LC43" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">KAFKA_BROKER_ID</span>: <span class="pl-c1">2</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L44"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="44"></td>
                    <td id="file-docker-compose-yaml-LC44" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">KAFKA_ZOOKEEPER_CONNECT</span>: <span class="pl-s"><span
                      class="pl-pds">&#39;</span>zookeeper:2181<span class="pl-pds">&#39;</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L45"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="45"></td>
                    <td id="file-docker-compose-yaml-LC45" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">KAFKA_LISTENER_SECURITY_PROTOCOL_MAP</span>: <span class="pl-s">PLAINTEXT:PLAINTEXT,PLAINTEXT_HOST:PLAINTEXT</span>
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L46"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="46"></td>
                    <td id="file-docker-compose-yaml-LC46" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">KAFKA_ADVERTISED_LISTENERS</span>: <span class="pl-s">PLAINTEXT://broker2:29093,PLAINTEXT_HOST://localhost:9093</span>
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L47"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="47"></td>
                    <td id="file-docker-compose-yaml-LC47" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">KAFKA_OFFSETS_TOPIC_REPLICATION_FACTOR</span>: <span class="pl-c1">1</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L48"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="48"></td>
                    <td id="file-docker-compose-yaml-LC48" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">KAFKA_TRANSACTION_STATE_LOG_MIN_ISR</span>: <span class="pl-c1">1</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L49"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="49"></td>
                    <td id="file-docker-compose-yaml-LC49" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">KAFKA_TRANSACTION_STATE_LOG_REPLICATION_FACTOR</span>: <span class="pl-c1">1</span>
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L50"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="50"></td>
                    <td id="file-docker-compose-yaml-LC50" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">KAFKA_GROUP_INITIAL_REBALANCE_DELAY_MS</span>: <span class="pl-c1">0</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L51"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="51"></td>
                    <td id="file-docker-compose-yaml-LC51" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L52"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="52"></td>
                    <td id="file-docker-compose-yaml-LC52" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">broker3</span>:
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L53"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="53"></td>
                    <td id="file-docker-compose-yaml-LC53" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">image</span>: <span class="pl-s">confluentinc/cp-kafka:5.5.1</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L54"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="54"></td>
                    <td id="file-docker-compose-yaml-LC54" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">hostname</span>: <span class="pl-s">broker3</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L55"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="55"></td>
                    <td id="file-docker-compose-yaml-LC55" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">container_name</span>: <span class="pl-s">broker3</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L56"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="56"></td>
                    <td id="file-docker-compose-yaml-LC56" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">depends_on</span>:
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L57"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="57"></td>
                    <td id="file-docker-compose-yaml-LC57" class="blob-code blob-code-inner js-file-line"> - <span
                      class="pl-s">zookeeper</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L58"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="58"></td>
                    <td id="file-docker-compose-yaml-LC58" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">ports</span>:
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L59"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="59"></td>
                    <td id="file-docker-compose-yaml-LC59" class="blob-code blob-code-inner js-file-line"> - <span
                      class="pl-c1">29094:29094</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L60"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="60"></td>
                    <td id="file-docker-compose-yaml-LC60" class="blob-code blob-code-inner js-file-line"> - <span
                      class="pl-c1">9094:9094</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L61"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="61"></td>
                    <td id="file-docker-compose-yaml-LC61" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">environment</span>:
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L62"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="62"></td>
                    <td id="file-docker-compose-yaml-LC62" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">KAFKA_BROKER_ID</span>: <span class="pl-c1">3</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L63"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="63"></td>
                    <td id="file-docker-compose-yaml-LC63" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">KAFKA_ZOOKEEPER_CONNECT</span>: <span class="pl-s"><span
                      class="pl-pds">&#39;</span>zookeeper:2181<span class="pl-pds">&#39;</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L64"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="64"></td>
                    <td id="file-docker-compose-yaml-LC64" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">KAFKA_LISTENER_SECURITY_PROTOCOL_MAP</span>: <span class="pl-s">PLAINTEXT:PLAINTEXT,PLAINTEXT_HOST:PLAINTEXT</span>
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L65"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="65"></td>
                    <td id="file-docker-compose-yaml-LC65" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">KAFKA_ADVERTISED_LISTENERS</span>: <span class="pl-s">PLAINTEXT://broker3:29094,PLAINTEXT_HOST://localhost:9094</span>
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L66"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="66"></td>
                    <td id="file-docker-compose-yaml-LC66" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">KAFKA_OFFSETS_TOPIC_REPLICATION_FACTOR</span>: <span class="pl-c1">1</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L67"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="67"></td>
                    <td id="file-docker-compose-yaml-LC67" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">KAFKA_TRANSACTION_STATE_LOG_MIN_ISR</span>: <span class="pl-c1">1</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L68"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="68"></td>
                    <td id="file-docker-compose-yaml-LC68" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">KAFKA_TRANSACTION_STATE_LOG_REPLICATION_FACTOR</span>: <span class="pl-c1">1</span>
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L69"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="69"></td>
                    <td id="file-docker-compose-yaml-LC69" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">KAFKA_GROUP_INITIAL_REBALANCE_DELAY_MS</span>: <span class="pl-c1">0</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L70"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="70"></td>
                    <td id="file-docker-compose-yaml-LC70" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L71"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="71"></td>
                    <td id="file-docker-compose-yaml-LC71" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">schema-registry</span>:
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L72"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="72"></td>
                    <td id="file-docker-compose-yaml-LC72" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">image</span>: <span class="pl-s">confluentinc/cp-schema-registry:5.5.1</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L73"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="73"></td>
                    <td id="file-docker-compose-yaml-LC73" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">hostname</span>: <span class="pl-s">schema-registry</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L74"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="74"></td>
                    <td id="file-docker-compose-yaml-LC74" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">container_name</span>: <span class="pl-s">schema-registry</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L75"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="75"></td>
                    <td id="file-docker-compose-yaml-LC75" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">depends_on</span>:
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L76"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="76"></td>
                    <td id="file-docker-compose-yaml-LC76" class="blob-code blob-code-inner js-file-line"> - <span
                      class="pl-s">zookeeper</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L77"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="77"></td>
                    <td id="file-docker-compose-yaml-LC77" class="blob-code blob-code-inner js-file-line"> - <span
                      class="pl-s">broker1</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L78"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="78"></td>
                    <td id="file-docker-compose-yaml-LC78" class="blob-code blob-code-inner js-file-line"> - <span
                      class="pl-s">broker2</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L79"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="79"></td>
                    <td id="file-docker-compose-yaml-LC79" class="blob-code blob-code-inner js-file-line"> - <span
                      class="pl-s">broker3</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L80"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="80"></td>
                    <td id="file-docker-compose-yaml-LC80" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">ports</span>:
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L81"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="81"></td>
                    <td id="file-docker-compose-yaml-LC81" class="blob-code blob-code-inner js-file-line"> - <span
                      class="pl-c1">8081:8081</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L82"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="82"></td>
                    <td id="file-docker-compose-yaml-LC82" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">environment</span>:
                    </td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L83"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="83"></td>
                    <td id="file-docker-compose-yaml-LC83" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">SCHEMA_REGISTRY_HOST_NAME</span>: <span class="pl-s">schema-registry</span></td>
                  </tr>
                  <tr>
                    <td id="file-docker-compose-yaml-L84"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="84"></td>
                    <td id="file-docker-compose-yaml-LC84" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-ent">SCHEMA_REGISTRY_KAFKASTORE_CONNECTION_URL</span>: <span class="pl-s"><span
                      class="pl-pds">&#39;</span>zookeeper:2181<span class="pl-pds">&#39;</span></span></td>
                  </tr>
                </table>
              </div>
      ...
      <div class="gist-meta">
        <a
          ...
          href="https://gist.github.com/irajhedayati/90602da2e63c9121e32ca020507e7f28/raw/5c00baf52edeed0fde45b343f3e48b21158ab2e4/docker-compose.yaml" style="float:right">view raw</a>
        <a class="Link--inTextBlock"
           href="https://gist.github.com/irajhedayati/90602da2e63c9121e32ca020507e7f28#file-docker-compose-yaml">
          docker-compose.yaml
        </a>
...
<script>
export default { name: 'KafkaMultiBrokerGist' }
</script>
<style>
.gist {
  /*!
