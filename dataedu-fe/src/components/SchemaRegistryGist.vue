<template>
  <div id="gist106988521" class="gist">
    <div class="gist-file" translate="no">
      <div class="gist-data">
        <div class="js-gist-file-update-container js-task-list-container file-box">
          <div id="file-register-avro-schema-sh" class="file my-2">
    ...
    <path
      d="M6.457 1.047c.659-1.234 2.427-1.234 3.086 0l6.082 11.378A1.75 1.75 0 0 1 14.082 15H1.918a1.75 1.75 0 0 1-1.543-2.575Zm1.763.707a.25.25 0 0 0-.44 0L1.698 13.132a.25.25 0 0 0 .22.368h12.164a.25.25 0 0 0 .22-.368Zm.53 3.996v2.5a.75.75 0 0 1-1.5 0v-2.5a.75.75 0 0 1 1.5 0ZM9 11a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"></path>
                ...
                <table class="highlight tab-size js-file-line-container js-code-nav-container js-tagsearch-file"
                       ...
                       data-tagsearch-path="register-avro-schema.sh">
                  <tr>
                    <td id="file-register-avro-schema-sh-L1"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="1"></td>
                    <td id="file-register-avro-schema-sh-LC1" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c"><span class="pl-c">#!</span>/bin/bash</span></td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L2"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="2"></td>
                    <td id="file-register-avro-schema-sh-LC2" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c1">set</span> -e
                    </td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L3"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="3"></td>
                    <td id="file-register-avro-schema-sh-LC3" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-en">usage</span>() {
                    </td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L4"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="4"></td>
                    <td id="file-register-avro-schema-sh-LC4" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c1">echo</span> <span class="pl-s"><span class="pl-pds">&quot;</span> Register Avro schema from a file in a Schema Registry<span
                      class="pl-pds">&quot;</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L5"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="5"></td>
                    <td id="file-register-avro-schema-sh-LC5" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c1">echo</span> <span class="pl-s"><span class="pl-pds">&quot;</span><span
                      class="pl-pds">&quot;</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L6"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="6"></td>
                    <td id="file-register-avro-schema-sh-LC6" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c1">echo</span> <span class="pl-s"><span class="pl-pds">&quot;</span> Usage:<span
                      class="pl-pds">&quot;</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L7"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="7"></td>
                    <td id="file-register-avro-schema-sh-LC7" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c1">echo</span> <span class="pl-s"><span class="pl-pds">&quot;</span>     register-avro-schema.sh &lt;Options&gt;<span
                      class="pl-pds">&quot;</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L8"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="8"></td>
                    <td id="file-register-avro-schema-sh-LC8" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c1">echo</span> <span class="pl-s"><span class="pl-pds">&quot;</span><span
                      class="pl-pds">&quot;</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L9"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="9"></td>
                    <td id="file-register-avro-schema-sh-LC9" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c1">echo</span> <span class="pl-s"><span class="pl-pds">&quot;</span> Options:<span
                      class="pl-pds">&quot;</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L10"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="10"></td>
                    <td id="file-register-avro-schema-sh-LC10" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c1">echo</span> <span class="pl-s"><span class="pl-pds">&quot;</span>     -r   the URL of the Schema Registry e.g. http://localhost:8081<span
                      class="pl-pds">&quot;</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L11"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="11"></td>
                    <td id="file-register-avro-schema-sh-LC11" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c1">echo</span> <span class="pl-s"><span class="pl-pds">&quot;</span>     -s   subject name<span
                      class="pl-pds">&quot;</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L12"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="12"></td>
                    <td id="file-register-avro-schema-sh-LC12" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c1">echo</span> <span class="pl-s"><span class="pl-pds">&quot;</span>     -f   path to the file that contains the Avro schema<span
                      class="pl-pds">&quot;</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L13"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="13"></td>
                    <td id="file-register-avro-schema-sh-LC13" class="blob-code blob-code-inner js-file-line">}</td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L14"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="14"></td>
                    <td id="file-register-avro-schema-sh-LC14" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-k">while</span> <span class="pl-c1">getopts</span> <span class="pl-s"><span
                      class="pl-pds">&quot;</span>r:s:f:<span class="pl-pds">&quot;</span></span> opt<span class="pl-k">;</span>
                      <span class="pl-k">do</span></td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L15"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="15"></td>
                    <td id="file-register-avro-schema-sh-LC15" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-k">case</span> <span class="pl-smi">${opt}</span> <span class="pl-k">in</span></td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L16"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="16"></td>
                    <td id="file-register-avro-schema-sh-LC16" class="blob-code blob-code-inner js-file-line"> r)
                      SCHEMA_REGISTRY_URL=<span class="pl-smi">$OPTARG</span> ;;
                    </td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L17"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="17"></td>
                    <td id="file-register-avro-schema-sh-LC17" class="blob-code blob-code-inner js-file-line"> s)
                      SUBJECT=<span class="pl-smi">$OPTARG</span> ;;
                    </td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L18"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="18"></td>
                    <td id="file-register-avro-schema-sh-LC18" class="blob-code blob-code-inner js-file-line"> f)
                      FILE_PATH=<span class="pl-smi">$OPTARG</span> ;;
                    </td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L19"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="19"></td>
                    <td id="file-register-avro-schema-sh-LC19" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-cce">\?</span>)
                    </td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L20"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="20"></td>
                    <td id="file-register-avro-schema-sh-LC20" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c1">echo</span> <span class="pl-s"><span
                      class="pl-pds">&quot;</span>Invalid option: -<span class="pl-smi">$OPTARG</span><span
                      class="pl-pds">&quot;</span></span> <span class="pl-k">&gt;&amp;2</span></td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L21"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="21"></td>
                    <td id="file-register-avro-schema-sh-LC21" class="blob-code blob-code-inner js-file-line"> usage
                    </td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L22"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="22"></td>
                    <td id="file-register-avro-schema-sh-LC22" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c1">exit</span> 1<span class="pl-k">;</span></td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L23"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="23"></td>
                    <td id="file-register-avro-schema-sh-LC23" class="blob-code blob-code-inner js-file-line"> ;;</td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L24"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="24"></td>
                    <td id="file-register-avro-schema-sh-LC24" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-k">esac</span></td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L25"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="25"></td>
                    <td id="file-register-avro-schema-sh-LC25" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-k">done</span></td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L26"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="26"></td>
                    <td id="file-register-avro-schema-sh-LC26" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L27"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="27"></td>
                    <td id="file-register-avro-schema-sh-LC27" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-k">if</span> [[ <span class="pl-k">-z</span> <span
                      class="pl-smi">${SCHEMA_REGISTRY_URL}</span> ]]<span class="pl-k">;</span> <span
                      class="pl-k">then</span></td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L28"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="28"></td>
                    <td id="file-register-avro-schema-sh-LC28" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c1">echo</span> <span class="pl-s"><span class="pl-pds">&quot;</span>The URL of the schema registry is not provided<span
                      class="pl-pds">&quot;</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L29"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="29"></td>
                    <td id="file-register-avro-schema-sh-LC29" class="blob-code blob-code-inner js-file-line"> usage
                    </td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L30"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="30"></td>
                    <td id="file-register-avro-schema-sh-LC30" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c1">exit</span> 1
                    </td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L31"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="31"></td>
                    <td id="file-register-avro-schema-sh-LC31" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-k">fi</span></td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L32"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="32"></td>
                    <td id="file-register-avro-schema-sh-LC32" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-k">if</span> [[ <span class="pl-k">-z</span> <span class="pl-smi">${SUBJECT}</span>
                      ]]<span class="pl-k">;</span> <span class="pl-k">then</span></td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L33"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="33"></td>
                    <td id="file-register-avro-schema-sh-LC33" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c1">echo</span> <span class="pl-s"><span class="pl-pds">&quot;</span>The subject is not provided<span
                      class="pl-pds">&quot;</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L34"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="34"></td>
                    <td id="file-register-avro-schema-sh-LC34" class="blob-code blob-code-inner js-file-line"> usage
                    </td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L35"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="35"></td>
                    <td id="file-register-avro-schema-sh-LC35" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c1">exit</span> 1
                    </td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L36"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="36"></td>
                    <td id="file-register-avro-schema-sh-LC36" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-k">fi</span></td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L37"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="37"></td>
                    <td id="file-register-avro-schema-sh-LC37" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-k">if</span> [[ <span class="pl-k">-z</span> <span class="pl-smi">${FILE_PATH}</span> ]]<span
                      class="pl-k">;</span> <span class="pl-k">then</span></td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L38"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="38"></td>
                    <td id="file-register-avro-schema-sh-LC38" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c1">echo</span> <span class="pl-s"><span class="pl-pds">&quot;</span>The file path to Avro schema is not provided<span
                      class="pl-pds">&quot;</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L39"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="39"></td>
                    <td id="file-register-avro-schema-sh-LC39" class="blob-code blob-code-inner js-file-line"> usage
                    </td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L40"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="40"></td>
                    <td id="file-register-avro-schema-sh-LC40" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c1">exit</span> 1
                    </td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L41"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="41"></td>
                    <td id="file-register-avro-schema-sh-LC41" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-k">fi</span></td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L42"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="42"></td>
                    <td id="file-register-avro-schema-sh-LC42" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L43"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="43"></td>
                    <td id="file-register-avro-schema-sh-LC43" class="blob-code blob-code-inner js-file-line">
                      SCHEMA=<span class="pl-s"><span class="pl-pds">&#39;</span>{&quot;schema&quot;:&quot;<span
                      class="pl-pds">&#39;</span></span><span class="pl-s"><span class="pl-pds">$(</span>cat <span
                      class="pl-smi">${FILE_PATH}</span> <span class="pl-k">|</span> tr <span class="pl-s"><span
                      class="pl-pds">&#39;</span>\n<span class="pl-pds">&#39;</span></span> <span class="pl-s"><span
                      class="pl-pds">&#39;</span>\r<span class="pl-pds">&#39;</span></span> <span class="pl-k">|</span> sed  <span
                      class="pl-s"><span class="pl-pds">&#39;</span>s/&quot;/\\&quot;/g<span class="pl-pds">&#39;</span></span> <span
                      class="pl-k">|</span> sed <span class="pl-s"><span class="pl-pds">&#39;</span>s/\s//g<span
                      class="pl-pds">&#39;</span></span><span class="pl-pds">)</span></span><span class="pl-s"><span
                      class="pl-pds">&#39;</span>&quot;}<span class="pl-pds">&#39;</span></span></td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L44"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="44"></td>
                    <td id="file-register-avro-schema-sh-LC44" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c1">echo</span> <span class="pl-smi">$SCHEMA</span> <span class="pl-k">&gt;</span>
                      ./tmp.json
                    </td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L45"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="45"></td>
                    <td id="file-register-avro-schema-sh-LC45" class="blob-code blob-code-inner js-file-line">curl -X
                      POST -H <span class="pl-s"><span class="pl-pds">&quot;</span>Content-Type: application/vnd.schemaregistry.v1+json<span
                        class="pl-pds">&quot;</span></span> --data @./tmp.json <span class="pl-smi">${SCHEMA_REGISTRY_URL}</span>/subjects/<span
                        class="pl-smi">${SUBJECT}</span>/versions
                    </td>
                  </tr>
                  <tr>
                    <td id="file-register-avro-schema-sh-L46"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="46"></td>
                    <td id="file-register-avro-schema-sh-LC46" class="blob-code blob-code-inner js-file-line">rm -f
                      ./tmp.json
                    </td>
                  </tr>
                </table>
      ...
      <div class="gist-meta">
        <a
          ...
          href="https://gist.github.com/irajhedayati/df7fc8bf22b0c0cb5d2ca0ed936df77f/raw/7c1b828222ceae41b5770e67282a4a480c824a65/register-avro-schema.sh" style="float:right">view raw</a>
        <a class="Link--inTextBlock"
           href="https://gist.github.com/irajhedayati/df7fc8bf22b0c0cb5d2ca0ed936df77f#file-register-avro-schema-sh">
          register-avro-schema.sh
        </a>
...
<script>
export default { name: 'SchemaRegistryGist' }
</script>
<style>
.gist {
  /*!
