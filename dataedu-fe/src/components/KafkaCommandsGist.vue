<template>
  <div id="gist106546397" class="gist">
    <div class="gist-file" translate="no">
      <div class="gist-data">
        <div class="js-gist-file-update-container js-task-list-container file-box">
          <div id="file-1-kafka-tutorial-topic-sh" class="file my-2">

            <div class="Box-body p-0 blob-wrapper data type-shell  " itemprop="text">
  ...
  <span aria-label="This line has hidden Unicode characters" class="line-alert tooltipped tooltipped-e"
    ...
    <path
      d="M6.457 1.047c.659-1.234 2.427-1.234 3.086 0l6.082 11.378A1.75 1.75 0 0 1 14.082 15H1.918a1.75 1.75 0 0 1-1.543-2.575Zm1.763.707a.25.25 0 0 0-.44 0L1.698 13.132a.25.25 0 0 0 .22.368h12.164a.25.25 0 0 0 .22-.368Zm.53 3.996v2.5a.75.75 0 0 1-1.5 0v-2.5a.75.75 0 0 1 1.5 0ZM9 11a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"></path>
                ...
                <table class="highlight tab-size js-file-line-container js-code-nav-container js-tagsearch-file"
                       data-hpc
                       data-paste-markdown-skip data-tab-size="8" data-tagsearch-lang="Shell"
                       data-tagsearch-path="1.Kafka-tutorial-topic.sh">
                  <tr>
                    <td id="file-1-kafka-tutorial-topic-sh-L1"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="1"></td>
                    <td id="file-1-kafka-tutorial-topic-sh-LC1" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c"><span class="pl-c">#</span> Section 1: topic</span></td>
                  </tr>
                  <tr>
                    <td id="file-1-kafka-tutorial-topic-sh-L2"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="2"></td>
                    <td id="file-1-kafka-tutorial-topic-sh-LC2" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c"><span class="pl-c">#</span> To see different options and help on a command, just run it without any parameter</span>
                    </td>
                  </tr>
                  <tr>
                    <td id="file-1-kafka-tutorial-topic-sh-L3"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="3"></td>
                    <td id="file-1-kafka-tutorial-topic-sh-LC3" class="blob-code blob-code-inner js-file-line">
                      kafka-topics
                    </td>
                  </tr>
                  <tr>
                    <td id="file-1-kafka-tutorial-topic-sh-L4"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="4"></td>
                    <td id="file-1-kafka-tutorial-topic-sh-LC4" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-1-kafka-tutorial-topic-sh-L5"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="5"></td>
                    <td id="file-1-kafka-tutorial-topic-sh-LC5" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c"><span class="pl-c">#</span> To create a topic with one partition and replication factor of 1</span>
                    </td>
                  </tr>
                  <tr>
                    <td id="file-1-kafka-tutorial-topic-sh-L6"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="6"></td>
                    <td id="file-1-kafka-tutorial-topic-sh-LC6" class="blob-code blob-code-inner js-file-line">
                      kafka-topics --zookeeper localhost:2181 --create --topic <span class="pl-c1">test</span>
                      --partitions 1 --replication-factor 1
                    </td>
                  </tr>
                  <tr>
                    <td id="file-1-kafka-tutorial-topic-sh-L7"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="7"></td>
                    <td id="file-1-kafka-tutorial-topic-sh-LC7" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-1-kafka-tutorial-topic-sh-L8"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="8"></td>
                    <td id="file-1-kafka-tutorial-topic-sh-LC8" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c"><span class="pl-c">#</span> To get a list of existing topics</span></td>
                  </tr>
                  <tr>
                    <td id="file-1-kafka-tutorial-topic-sh-L9"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="9"></td>
                    <td id="file-1-kafka-tutorial-topic-sh-LC9" class="blob-code blob-code-inner js-file-line">
                      kafka-topics --zookeeper localhost:2181 --list
                    </td>
                  </tr>
                  <tr>
                    <td id="file-1-kafka-tutorial-topic-sh-L10"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="10"></td>
                    <td id="file-1-kafka-tutorial-topic-sh-LC10" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-1-kafka-tutorial-topic-sh-L11"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="11"></td>
                    <td id="file-1-kafka-tutorial-topic-sh-LC11" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c"><span class="pl-c">#</span> To see details of the topic</span></td>
                  </tr>
                  <tr>
                    <td id="file-1-kafka-tutorial-topic-sh-L12"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="12"></td>
                    <td id="file-1-kafka-tutorial-topic-sh-LC12" class="blob-code blob-code-inner js-file-line">
                      kafka-topics --zookeeper localhost:2181 --describe --topic <span class="pl-c1">test</span></td>
                  </tr>
                  <tr>
                    <td id="file-1-kafka-tutorial-topic-sh-L13"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="13"></td>
                    <td id="file-1-kafka-tutorial-topic-sh-LC13" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-1-kafka-tutorial-topic-sh-L14"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="14"></td>
                    <td id="file-1-kafka-tutorial-topic-sh-LC14" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c"><span class="pl-c">#</span> To override default configuration; for example retention period</span>
                    </td>
                  </tr>
                  <tr>
                    <td id="file-1-kafka-tutorial-topic-sh-L15"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="15"></td>
                    <td id="file-1-kafka-tutorial-topic-sh-LC15" class="blob-code blob-code-inner js-file-line">
                      kafka-topics --zookeeper localhost:2181 --alter --topic <span class="pl-c1">test</span> --config
                      retention.ms=30000
                    </td>
                  </tr>
                  <tr>
                    <td id="file-1-kafka-tutorial-topic-sh-L16"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="16"></td>
                    <td id="file-1-kafka-tutorial-topic-sh-LC16" class="blob-code blob-code-inner js-file-line">
                      kafka-topics --zookeeper localhost:2181 --describe --topic <span class="pl-c1">test</span></td>
                  </tr>
                  <tr>
                    <td id="file-1-kafka-tutorial-topic-sh-L17"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="17"></td>
                    <td id="file-1-kafka-tutorial-topic-sh-LC17" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-1-kafka-tutorial-topic-sh-L18"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="18"></td>
                    <td id="file-1-kafka-tutorial-topic-sh-LC18" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c"><span class="pl-c">#</span> To change the number of partitions</span></td>
                  </tr>
                  <tr>
                    <td id="file-1-kafka-tutorial-topic-sh-L19"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="19"></td>
                    <td id="file-1-kafka-tutorial-topic-sh-LC19" class="blob-code blob-code-inner js-file-line">
                      kafka-topics --zookeeper localhost:2181 --alter --topic <span class="pl-c1">test</span>
                      --partitions 3
                    </td>
                  </tr>
                  <tr>
                    <td id="file-1-kafka-tutorial-topic-sh-L20"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="20"></td>
                    <td id="file-1-kafka-tutorial-topic-sh-LC20" class="blob-code blob-code-inner js-file-line">
                      kafka-topics --zookeeper localhost:2181 --describe --topic <span class="pl-c1">test</span></td>
                  </tr>
                  <tr>
                    <td id="file-1-kafka-tutorial-topic-sh-L21"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="21"></td>
                    <td id="file-1-kafka-tutorial-topic-sh-LC21" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-1-kafka-tutorial-topic-sh-L22"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="22"></td>
                    <td id="file-1-kafka-tutorial-topic-sh-LC22" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c"><span class="pl-c">#</span> To delete a topic</span></td>
                  </tr>
                  <tr>
                    <td id="file-1-kafka-tutorial-topic-sh-L23"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="23"></td>
                    <td id="file-1-kafka-tutorial-topic-sh-LC23" class="blob-code blob-code-inner js-file-line">
                      kafka-topics --zookeeper localhost:2181 --delete --topic <span class="pl-c1">test</span></td>
                  </tr>
                  <tr>
                    <td id="file-1-kafka-tutorial-topic-sh-L24"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="24"></td>
                    <td id="file-1-kafka-tutorial-topic-sh-LC24" class="blob-code blob-code-inner js-file-line">
                      kafka-topics --zookeeper localhost:2181 --list
                    </td>
                  </tr>
                </table>
      ...
      <div class="gist-meta">
        <a
          ...
          href="https://gist.github.com/irajhedayati/52686f745893e7439ca06653c2daa758/raw/7821df93333daead02aa1c22c0d6962bf88b6dae/1.Kafka-tutorial-topic.sh" style="float:right">view raw</a>
        <a class="Link--inTextBlock"
           href="https://gist.github.com/irajhedayati/52686f745893e7439ca06653c2daa758#file-1-kafka-tutorial-topic-sh">
          1.Kafka-tutorial-topic.sh
        </a>
    ...
    <div class="gist-file" translate="no">
      <div class="gist-data">
        <div class="js-gist-file-update-container js-task-list-container file-box">
          <div id="file-2-kafka-tutorial-consume-produce-sh" class="file my-2">
  ...
  <span aria-label="This line has hidden Unicode characters" class="line-alert tooltipped tooltipped-e"
    ...
    <path
      d="M6.457 1.047c.659-1.234 2.427-1.234 3.086 0l6.082 11.378A1.75 1.75 0 0 1 14.082 15H1.918a1.75 1.75 0 0 1-1.543-2.575Zm1.763.707a.25.25 0 0 0-.44 0L1.698 13.132a.25.25 0 0 0 .22.368h12.164a.25.25 0 0 0 .22-.368Zm.53 3.996v2.5a.75.75 0 0 1-1.5 0v-2.5a.75.75 0 0 1 1.5 0ZM9 11a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"></path>
                ...
                <table class="highlight tab-size js-file-line-container js-code-nav-container js-tagsearch-file"
                       data-hpc
                       data-paste-markdown-skip data-tab-size="8" data-tagsearch-lang="Shell"
                       data-tagsearch-path="2.Kafka-tutorial-consume-produce.sh">
                  <tr>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-L1"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="1"></td>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-LC1"
                        class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">#</span> Section 2: consume and produce</span>
                    </td>
                  </tr>
                  <tr>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-L2"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="2"></td>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-LC2"
                        class="blob-code blob-code-inner js-file-line">kafka-topics --zookeeper localhost:2181 --create
                      --topic movie --partitions 3 --replication-factor 1
                    </td>
                  </tr>
                  <tr>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-L3"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="3"></td>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-LC3"
                        class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-L4"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="4"></td>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-LC4"
                        class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">#</span> To produce to a topic using the commadn line</span>
                    </td>
                  </tr>
                  <tr>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-L5"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="5"></td>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-LC5"
                        class="blob-code blob-code-inner js-file-line">kafka-console-producer --broker-list
                      localhost:9092 --topic movie
                    </td>
                  </tr>
                  <tr>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-L6"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="6"></td>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-LC6"
                        class="blob-code blob-code-inner js-file-line"><span class="pl-k">&gt;</span> 101,Gone with the
                      Wind,1939,Victor Fleming
                    </td>
                  </tr>
                  <tr>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-L7"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="7"></td>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-LC7"
                        class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-L8"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="8"></td>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-LC8"
                        class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">#</span> To consume from a topic using the command line</span>
                    </td>
                  </tr>
                  <tr>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-L9"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="9"></td>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-LC9"
                        class="blob-code blob-code-inner js-file-line">kafka-console-consumer --bootstrap-server
                      localhost:9092 --topic movie
                    </td>
                  </tr>
                  <tr>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-L10"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="10"></td>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-LC10"
                        class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-L11"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="11"></td>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-LC11"
                        class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">#</span> Produce new record</span>
                    </td>
                  </tr>
                  <tr>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-L12"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="12"></td>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-LC12"
                        class="blob-code blob-code-inner js-file-line"><span class="pl-k">&gt;</span> 102,Star
                      Wars,1977,George Lucas
                    </td>
                  </tr>
                  <tr>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-L13"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="13"></td>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-LC13"
                        class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-L14"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="14"></td>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-LC14"
                        class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">#</span> It shows in the output of the consumer</span>
                    </td>
                  </tr>
                  <tr>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-L15"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="15"></td>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-LC15"
                        class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">#</span> To force a consumer to consume all the messages </span>
                    </td>
                  </tr>
                  <tr>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-L16"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="16"></td>
                    <td id="file-2-kafka-tutorial-consume-produce-sh-LC16"
                        class="blob-code blob-code-inner js-file-line">kafka-console-consumer --bootstrap-server
                      localhost:9092 --topic movie --from-beginning
                    </td>
                  </tr>
                </table>
              </div>
      ...
      <div class="gist-meta">
        <a
          class="Link--inTextBlock"
          href="https://gist.github.com/irajhedayati/52686f745893e7439ca06653c2daa758/raw/7821df93333daead02aa1c22c0d6962bf88b6dae/2.Kafka-tutorial-consume-produce.sh" style="float:right">view raw</a>
        <a
          class="Link--inTextBlock"
          href="https://gist.github.com/irajhedayati/52686f745893e7439ca06653c2daa758#file-2-kafka-tutorial-consume-produce-sh">
          2.Kafka-tutorial-consume-produce.sh
        </a>
        hosted with &#10084; by <a class="Link--inTextBlock" href="https://github.com">GitHub</a>
      </div>
    </div>
    <div class="gist-file" translate="no">
      <div class="gist-data">
        <div class="js-gist-file-update-container js-task-list-container file-box">
          <div id="file-3-kafka-tutorial-consumer-group-sh" class="file my-2">
  ...
  <span aria-label="This line has hidden Unicode characters" class="line-alert tooltipped tooltipped-e"
    ...
    <path
      d="M6.457 1.047c.659-1.234 2.427-1.234 3.086 0l6.082 11.378A1.75 1.75 0 0 1 14.082 15H1.918a1.75 1.75 0 0 1-1.543-2.575Zm1.763.707a.25.25 0 0 0-.44 0L1.698 13.132a.25.25 0 0 0 .22.368h12.164a.25.25 0 0 0 .22-.368Zm.53 3.996v2.5a.75.75 0 0 1-1.5 0v-2.5a.75.75 0 0 1 1.5 0ZM9 11a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"></path>
                ...
                <table class="highlight tab-size js-file-line-container js-code-nav-container js-tagsearch-file"
                       data-hpc
                       data-paste-markdown-skip data-tab-size="8" data-tagsearch-lang="Shell"
                       data-tagsearch-path="3.Kafka-tutorial-consumer-group.sh">
                  <tr>
                    <td id="file-3-kafka-tutorial-consumer-group-sh-L1"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="1"></td>
                    <td id="file-3-kafka-tutorial-consumer-group-sh-LC1" class="blob-code blob-code-inner js-file-line">
                      <span class="pl-c"><span class="pl-c">#</span> Section 3: Consumer groups</span></td>
                  </tr>
                  <tr>
                    <td id="file-3-kafka-tutorial-consumer-group-sh-L2"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="2"></td>
                    <td id="file-3-kafka-tutorial-consumer-group-sh-LC2" class="blob-code blob-code-inner js-file-line">
                      <span class="pl-c"><span class="pl-c">#</span> Get the list of consumer groups</span></td>
                  </tr>
                  <tr>
                    <td id="file-3-kafka-tutorial-consumer-group-sh-L3"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="3"></td>
                    <td id="file-3-kafka-tutorial-consumer-group-sh-LC3" class="blob-code blob-code-inner js-file-line">
                      kafka-consumer-groups --bootstrap-server localhost:9092 --list
                    </td>
                  </tr>
                  <tr>
                    <td id="file-3-kafka-tutorial-consumer-group-sh-L4"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="4"></td>
                    <td id="file-3-kafka-tutorial-consumer-group-sh-LC4" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-3-kafka-tutorial-consumer-group-sh-L5"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="5"></td>
                    <td id="file-3-kafka-tutorial-consumer-group-sh-LC5" class="blob-code blob-code-inner js-file-line">
                      <span class="pl-c"><span class="pl-c">#</span> Describe a consumer group to get more information like LAG</span>
                    </td>
                  </tr>
                  <tr>
                    <td id="file-3-kafka-tutorial-consumer-group-sh-L6"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="6"></td>
                    <td id="file-3-kafka-tutorial-consumer-group-sh-LC6" class="blob-code blob-code-inner js-file-line">
      ...
      <div class="gist-meta">
        <a
          class="Link--inTextBlock"
          href="https://gist.github.com/irajhedayati/52686f745893e7439ca06653c2daa758/raw/7821df93333daead02aa1c22c0d6962bf88b6dae/3.Kafka-tutorial-consumer-group.sh" style="float:right">view raw</a>
        <a
          class="Link--inTextBlock"
          href="https://gist.github.com/irajhedayati/52686f745893e7439ca06653c2daa758#file-3-kafka-tutorial-consumer-group-sh">
          3.Kafka-tutorial-consumer-group.sh
        </a>
        hosted with &#10084; by <a class="Link--inTextBlock" href="https://github.com">GitHub</a>
      </div>
    </div>
    <div class="gist-file" translate="no">
      <div class="gist-data">
        <div class="js-gist-file-update-container js-task-list-container file-box">
          <div id="file-4-kafka-tutorial-partition-sh" class="file my-2">
    ...
    <path
      d="M6.457 1.047c.659-1.234 2.427-1.234 3.086 0l6.082 11.378A1.75 1.75 0 0 1 14.082 15H1.918a1.75 1.75 0 0 1-1.543-2.575Zm1.763.707a.25.25 0 0 0-.44 0L1.698 13.132a.25.25 0 0 0 .22.368h12.164a.25.25 0 0 0 .22-.368Zm.53 3.996v2.5a.75.75 0 0 1-1.5 0v-2.5a.75.75 0 0 1 1.5 0ZM9 11a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"></path>
                ...
                <table class="highlight tab-size js-file-line-container js-code-nav-container js-tagsearch-file"
                       data-hpc
                       data-paste-markdown-skip data-tab-size="8" data-tagsearch-lang="Shell"
                       data-tagsearch-path="4.Kafka-tutorial-partition.sh">
                  <tr>
                    <td id="file-4-kafka-tutorial-partition-sh-L1"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="1"></td>
                    <td id="file-4-kafka-tutorial-partition-sh-LC1" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c"><span class="pl-c">#</span> Section 4: partitions</span></td>
                  </tr>
                  <tr>
                    <td id="file-4-kafka-tutorial-partition-sh-L2"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="2"></td>
                    <td id="file-4-kafka-tutorial-partition-sh-LC2" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c"><span class="pl-c">#</span> Launch consumers to consume from specific </span></td>
                  </tr>
                  <tr>
                    <td id="file-4-kafka-tutorial-partition-sh-L3"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="3"></td>
                    <td id="file-4-kafka-tutorial-partition-sh-LC3" class="blob-code blob-code-inner js-file-line">
                      kafka-console-consumer --bootstrap-server localhost:9092 --topic movie --partition 0
                    </td>
                  </tr>
                  <tr>
                    <td id="file-4-kafka-tutorial-partition-sh-L4"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="4"></td>
                    <td id="file-4-kafka-tutorial-partition-sh-LC4" class="blob-code blob-code-inner js-file-line">
                      kafka-console-consumer --bootstrap-server localhost:9092 --topic movie --partition 1
                    </td>
                  </tr>
                  <tr>
                    <td id="file-4-kafka-tutorial-partition-sh-L5"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="5"></td>
                    <td id="file-4-kafka-tutorial-partition-sh-LC5" class="blob-code blob-code-inner js-file-line">
                      kafka-console-consumer --bootstrap-server localhost:9092 --topic movie --partition 2
                    </td>
                  </tr>
                  <tr>
                    <td id="file-4-kafka-tutorial-partition-sh-L6"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="6"></td>
                    <td id="file-4-kafka-tutorial-partition-sh-LC6" class="blob-code blob-code-inner js-file-line">
                    </td>
                  </tr>
                  <tr>
                    <td id="file-4-kafka-tutorial-partition-sh-L7"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="7"></td>
                    <td id="file-4-kafka-tutorial-partition-sh-LC7" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-c"><span class="pl-c">#</span> Produce more messages</span></td>
                  </tr>
                  <tr>
                    <td id="file-4-kafka-tutorial-partition-sh-L8"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="8"></td>
                    <td id="file-4-kafka-tutorial-partition-sh-LC8" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-k">&gt;</span> 103,The Sound of Music,1965,Robert Wise
                    </td>
                  </tr>
                  <tr>
                    <td id="file-4-kafka-tutorial-partition-sh-L9"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="9"></td>
                    <td id="file-4-kafka-tutorial-partition-sh-LC9" class="blob-code blob-code-inner js-file-line"><span
                      class="pl-k">&gt;</span> 104,E.T.,1982,Steven Spielberg
                    </td>
                  </tr>
                  <tr>
                    <td id="file-4-kafka-tutorial-partition-sh-L10"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="10"></td>
                    <td id="file-4-kafka-tutorial-partition-sh-LC10" class="blob-code blob-code-inner js-file-line">
                      <span class="pl-k">&gt;</span> 105,Titanic,1997,James Cameron
                    </td>
                  </tr>
                  <tr>
                    <td id="file-4-kafka-tutorial-partition-sh-L11"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="11"></td>
                    <td id="file-4-kafka-tutorial-partition-sh-LC11" class="blob-code blob-code-inner js-file-line">
                      <span class="pl-k">&gt;</span> 106,Snow White,1937,
                    </td>
                  </tr>
                  <tr>
                    <td id="file-4-kafka-tutorial-partition-sh-L12"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="12"></td>
                    <td id="file-4-kafka-tutorial-partition-sh-LC12" class="blob-code blob-code-inner js-file-line">
                      <span class="pl-k">&gt;</span> 107,Avatar,2009,James Cameron
                    </td>
                  </tr>
                  <tr>
                    <td id="file-4-kafka-tutorial-partition-sh-L13"
                        class="blob-num js-line-number js-code-nav-line-number js-blob-rnum" data-line-number="13"></td>
                    <td id="file-4-kafka-tutorial-partition-sh-LC13" class="blob-code blob-code-inner js-file-line">
                      <span class="pl-k">&gt;</span> 108,Raiders of the Lost Ark,1981,Steven Spielberg
                    </td>
                  </tr>
                </table>
              </div>
      ...
      <div class="gist-meta">
        <a
          class="Link--inTextBlock"
          href="https://gist.github.com/irajhedayati/52686f745893e7439ca06653c2daa758/raw/7821df93333daead02aa1c22c0d6962bf88b6dae/4.Kafka-tutorial-partition.sh" style="float:right">view raw</a>
        <a
          class="Link--inTextBlock"
          href="https://gist.github.com/irajhedayati/52686f745893e7439ca06653c2daa758#file-4-kafka-tutorial-partition-sh">
          4.Kafka-tutorial-partition.sh
        </a>
        hosted with &#10084; by <a class="Link--inTextBlock" href="https://github.com">GitHub</a>
      </div>
    </div>
...
<script>
export default { name: 'KafkaCommandsGist' }
</script>
<style>
.gist {
  /*!
